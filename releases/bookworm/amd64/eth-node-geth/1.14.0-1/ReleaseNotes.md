...
This release is a Debian package for [geth](https://github.com/ethereum/go-ethereum). The source is taken from the release tarball, which has been modified minimally through patches to ensure reproducibility. 

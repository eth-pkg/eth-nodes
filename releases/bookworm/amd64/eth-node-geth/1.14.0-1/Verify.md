...
```bash
git clone --branch /home/eniko/workspace/eth-nodes/releases/bookworm/amd64/eth-node-geth/1.14.0-1 git@github.com:eth-pkg/eth-nodes.git 
cd eth-nodes
cd /home/eniko/workspace/eth-nodes/releases/bookworm/amd64/eth-node-geth/1.14.0-1
```
...
Fork the `eth-pkg/eth-nodes` repository and create a branch called `verify//home/eniko/workspace/eth-nodes/releases/bookworm/amd64/eth-node-geth/1.14.0-1`. Create an empty markdown file in the project outside the `src` directories. Push and wait for GitHub Actions to run.

...
This release is a Debian package for [prysm](https://github.com/prysmaticlabs/prysm). The source is taken from the release tarball, which has been modified minimally through patches to ensure reproducibility. 
...
- Date and git commit is baked in, as there is no git information when building the client. See patches.

...
bin_package = "eth-node-reth-config"
...
depends=["eth-node-reth-config", "eth-node-mainnet-config"]
summary = "systemd service files for eth-node-reth using eth-node-reth-config and eth-node-mainnet-config"

name = "eth-node-mainnet-config-nethermind"
architecture = "any"
conflicts = []
recommends = []
...
depends=[]
add_files = [
    "debian/scripts/run-nethermind.sh /usr/lib/eth-node-mainnet-config-nethermind/bin/",
...
long_doc = """eth-node-mainnet-config-nethermind

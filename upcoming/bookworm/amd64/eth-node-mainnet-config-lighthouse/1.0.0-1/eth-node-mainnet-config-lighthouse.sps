name = "eth-node-mainnet-config-lighthouse"
architecture = "any"
conflicts = []
recommends = []
...
depends=[]
add_files = [
    "debian/scripts/run-lighthouse.sh /usr/lib/eth-node-mainnet-config-lighthouse/bin/",
...
long_doc = """eth-node-mainnet-config-lighthouse

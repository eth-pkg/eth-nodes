...
bin_package = "eth-node-config-erigon-testnet"
...
depends=["eth-node-config-erigon-testnet", "eth-node-testnet-config", "eth-node-testnet"]
summary = "systemd service files for eth-node-erigon using eth-node-config-erigon-testnet and eth-node-testnet-config"

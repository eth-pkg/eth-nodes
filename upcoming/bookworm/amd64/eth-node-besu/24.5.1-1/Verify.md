...
Fork the `eth-pkg/eth-nodes` repository and create a branch called `verify/releases/bookworm/amd64/eth-node-besu/24.3.3-1`. Create an empty markdown file in the project outside the `src` directories. Push and wait for GitHub Actions to run.

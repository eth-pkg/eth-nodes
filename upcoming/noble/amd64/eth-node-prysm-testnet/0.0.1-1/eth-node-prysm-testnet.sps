...
binary = "/usr/lib/eth-node-prysm-testnet/run-prysm-service.sh"
user = { name = "eth-node-prysm-testnet", group = true, create = { home = false } }
...
add_files = [
    "debian/scripts/run-prysm-service.sh /usr/lib/eth-node-prysm-testnet/", 
    "debian/scripts/run-prysm.sh /usr/lib/eth-node-prysm-testnet/bin/",
    "debian/scripts/postprocess.sh /usr/lib/eth-node-prysm-testnet",
    "debian/tmp/eth-node-prysm-testnet.service /lib/systemd/system/",
]
...
[config."prysm-testnet.conf".postprocess]
command = ["bash", "/usr/lib/eth-node-prysm-testnet/postprocess.sh"]

[config."prysm-testnet.conf"]
format = "plain"

[config."prysm-testnet.conf".ivars."PRSYM_CLI_EXECUTION_ENDPOINT"]
type = "string"
...
[config."prysm-testnet.conf".ivars."PRSYM_CLI_CHECKPOINT_SYNC_URL"]
type = "string"

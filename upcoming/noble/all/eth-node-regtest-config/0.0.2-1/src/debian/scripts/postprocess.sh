...
export BASEFEE_UPDATE_FRACTION_ELECTRA="${BASEFEE_UPDATE_FRACTION_ELECTRA:-5007716}"
...
export BASEFEE_UPDATE_FRACTION_FULU="${BASEFEE_UPDATE_FRACTION_FULU:-5007716}"

...
[config."erigon-regtest.yaml".hvars."authrpc_addr"]
type = "string"
template = "{/ENGINE_IP}"
# priority = "low"
...
[config."erigon-regtest.yaml".hvars."authrpc_jwtsecret"]
type = "string"
template = "{/JWT_FILE}"
# priority = "low"
...
[config."erigon-regtest.yaml".hvars."http_addr"]
type = "string"
template = "{/ENGINE_IP}"
# priority = "low"
...
[config."erigon-regtest.yaml".hvars."log_dir_path"]
type = "string"
